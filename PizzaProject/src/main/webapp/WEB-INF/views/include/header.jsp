...
<style>
    ...
    #sub-1{
        ...
        height : 40%;
        margin-right : auto;
        background-image: url(https://www.shuttledelivery.co.kr/uploads/pizza-school-logo_7ad690665f141e967af70967b6aee6ca1715676502.jpg);
    ...
    #sub-2{
        ...
        margin-left : auto;
        height : 40%;
        background-image: url(https://newsimg.sedaily.com/2017/02/09/1OC11IFHOE_1.jpg);
        background-size: cover;
        background-repeat: none;
    }
